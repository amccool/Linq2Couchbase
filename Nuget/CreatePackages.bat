...
@echo CreatePackages running in directory =
@cd
@echo CreatePackages version file = %VERSION% from base dir = %BASE_DIR% using nuget location = %NUGET_EXE%
...
@echo CreatePackages: Version = %VERSION% -- Drop location = %BASE_PATH%
...
:Usage
@ECHO Usage:
@ECHO    CreatePackages ^<Path to folder^> ^<VersionFile^>
EXIT /B -1
